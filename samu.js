...
sendFileFromUrl(twi.result[2].link, video, {quoted: fvid, caption: '🍒Samu330 | Gawr Gura💠', duration: 999999999})
addFilter(from)
break
...
sendFileFromUrl(ig.result, video, {quoted: fvid, caption: '🍒Samu330 | Gawr Gura💠', duration: 999999999})
addFilter(from)
break
		//»»————-　★　————-««\\
